...
def analise_detalhada():
    ...
    print(f"\nINSIGHTS PRINCIPAIS:")
    print(f"   • Dataset bem balanceado entre classes")
    print(f"   • Variedade significativa no comprimento dos reviews")
    print(f"   • Vocabulário rico e diversificado")
    print(f"   • Poucos reviews duplicados (qualidade alta)")
